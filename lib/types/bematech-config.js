module.exports = {
  ...
  HW_INIT: Buffer.from([
    ...
    0x12,             // DC2 => condensed OFF
    0x1D, 0x21, 0x00, // GS ! 0 => size normal
  ]),
  ...
  // Text format
  // Reset seguro SEM cair pra Font A:
  TXT_NORMAL: Buffer.from([
    0x1B, 0x45, 0x00,  // ESC E 0   (bold OFF)
    0x1B, 0x2D, 0x00,  // ESC - 0   (underline OFF)
    0x1D, 0x42, 0x00,  // GS  B 0   (invert OFF)
    0x1D, 0x21, 0x00,  // GS  ! 0   (size normal)
    0x1B, 0x4D, 0x01,  // ESC M 1   (Font B)
    0x12,              // DC2       (condensed OFF)
  ...
  TXT_FONT_A: Buffer.from([0x1b, 0x4d, 0x01]), // hard-map: A => B
